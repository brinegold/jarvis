...
export default function SignUpPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (authData.user) {
        // Create profile (BSC wallet will be auto-generated by database trigger)
        ...
        try {
          const walletResponse = await fetch('/api/bsc/generate-wallet', {
            method: 'POST',
            headers: {
          ...
          if (walletResponse.ok) {
            ...
            console.log('✅ BSC wallet generated using BSC service:', walletData.wallet_address)
          } else {
            const errorData = await walletResponse.json()
            console.error('Failed to generate BSC wallet:', errorData)
            // Don't fail registration if wallet generation fails
          }
        } catch (walletError) {
          console.error('Error generating BSC wallet:', walletError)
          // Don't fail registration if wallet generation fails
        }
